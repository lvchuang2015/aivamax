...
- Allowed service permissions: agent_runs, courses, export_course, generate_platform_assets, host_smoke_test, material_review, mcp_config_export, platforms, public_exports, release_gate, role_audit, run_audit, run_matrix, search_public_knowledge, status, student_coach_preview
