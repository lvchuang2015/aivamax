...
scenario: Instagram account safety cold-start + comment lead-generation validation
platforms: [instagram]
duration_days: 14
...
# AIvaMax Instagram Account Safety + Comment Lead-Generation 14-Day SOP
...
|---|---|---|---|
| Day 0 | Environment and account readiness | Bind proxies, disable duplicate proxy binding, group accounts, prepare keywords, confirm manual review owner. | No outreach actions |
| Day 1-3 | Identity and normal behavior footprint | Browse feed, watch Reels/Stories, light likes, natural pauses, no sales comments. | 0-1 non-promotional comment per account/day |
| Day 4-7 | Trust accumulation | Continue warm-up, add value-only comments on relevant posts, observe account health. | 0-1 value comment per account/day |
| Day 8-10 | Lead-source observation | Monitor target posts and high-intent comments, classify buyer intent and problem-aware comments. | 1-2 comments per healthy account/day |
| Day 11-14 | Light lead-generation validation | Test reviewed comment templates, reply only to relevant interactions, prepare review data. | 2-3 comments per healthy account/day; no mass DM |

## 6. Comment Lead-Generation Rules
