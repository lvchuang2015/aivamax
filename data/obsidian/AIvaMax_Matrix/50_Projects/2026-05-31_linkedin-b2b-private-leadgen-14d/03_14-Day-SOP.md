...
sop_id: SOP-LINKEDIN-Comment-LeadGen-14D-COURSE
platform: LinkedIn
...
## 1. 课程定位
这份手册是 AIvaMax 的公开课程交付版，用来训练学员把一个 LinkedIn 营销需求，拆成有平台逻辑、有风险边界、有人审动作、有复盘证据的执行方案。它不是放量脚本，也不是平台规则的照本宣科摘要，而是一套适合课堂讲解、学员练习和项目复盘的标准手册。
...
- 转化路径: 专业内容/评论 -> 主页可信度判断 -> 连接建立 -> 人工个性化沟通 -> 预约或资料发送。
...
## 5. 适用对象与不适用场景
### 适用对象
- 已经有基础产品、课程或服务，需要用 LinkedIn 做轻量获客验证的团队。
...
| PUB-D74390550938 | knowledge_fact | high | 用于确认内容和模板需要人审，转译为先准备素材与话术框架，再进入小批量验证。 |
