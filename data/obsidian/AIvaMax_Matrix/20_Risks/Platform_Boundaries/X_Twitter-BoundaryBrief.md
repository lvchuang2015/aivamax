...
## 3. 平台差异提醒
- 平台定位: 实时话题、观点表达、互动速度和公开讨论驱动的平台。
- 主要入口: 关键词搜索, 话题帖, Thread, 公开回复, 个人主页
- 成交路径: 关键词/热点监听 -> 高质量公开回复 -> 主页信任 -> 用户互动 -> 人工跟进或内容引导。
- 课程重点: 实时信号监听, 公开回复获客, Thread 内容矩阵, 关键词线索池
