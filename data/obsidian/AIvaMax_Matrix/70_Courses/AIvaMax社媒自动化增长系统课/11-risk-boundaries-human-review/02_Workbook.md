...
module_id: 11-risk-boundaries-human-review
module_number: 11
status: draft_v2
visibility: internal
risk_level: high
...
# Workbook - Module 11: Risk Boundaries And Human Review

## Student Task

Students audit a draft campaign and label each item as public-safe, internal-only, client-ready, or blocked.
